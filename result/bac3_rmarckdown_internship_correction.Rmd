...
str_split_fixed(final_viral_score$seqname, "\\||full", 2) -> final_viral_score[,c(1,10)]

final_viral_score[,-c(10)] -> final_viral_score
```
...
subset(final_viral_score, final_viral_score$max_score > 0.8) -> final_viral_score
...
# first I filter the evalue
subset(prophage_pfam_result_TAB, prophage_pfam_result_TAB$Evalue_full_seq < 1e-3) -> prophage_pfam_result_TAB_filter

# then if bias is more than half of bit score -> filter

as.numeric(prophage_pfam_result_TAB_filter$bias_full_seq) -> prophage_pfam_result_TAB_filter$bias_full_seq
as.numeric(prophage_pfam_result_TAB_filter$score_full_seq) ->prophage_pfam_result_TAB_filter$score_full_seq

subset(prophage_pfam_result_TAB_filter, prophage_pfam_result_TAB_filter$bias_full_seq < (prophage_pfam_result_TAB_filter$score_full_seq/2)) -> prophage_pfam_result_TAB_filter
...
(length(unique(prophage_pfam_result_TAB_filter$target_name))/length(unique(prophage_sequence_table$sequence_name)))*100
